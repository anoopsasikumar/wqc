...
- **apply_quantile_correlation(data, quantiles, ...)**: Applies the above analysis across a single Y variable and multiple X series, returning a consolidated data frame.
