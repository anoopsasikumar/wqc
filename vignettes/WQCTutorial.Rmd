...
- **apply_quantile_correlation(data, quantiles, ...)**: Applies the above analysis across a single X variables and multiple Y series, returning a consolidated data frame.
